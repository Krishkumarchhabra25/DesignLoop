...
const schema = yup.object().shape({
  degree: yup.string().required('Position is required'),
  stream: yup.string().required('Organisation is required'),
  shoolsorcollege: yup.string().required('Start date is required'),
  startedIn: yup.string().required('Start date is required'),
  studiedTill: yup.string().required('Start date is required'),
  summary: yup
    .string()
        ...
        <Controller
          ...
          render={({ field }) => (
            <FormInput
              ...
              onChangeText={field.onChange}
              error={errors.stream?.message}
              onClear={() => resetField('shoolsorcollege')}
              placeholder="GIRT University, Gunpur"
            />
          )}
        />
...
<View style={[styles.checkboxContainer, styles.fieldContainer]}>
 ...
 {/* Studied Till */}
<View style={styles.fieldContainer}>
  <Text style={styles.label}>Studied Till</Text>
  <Controller
    control={control}
    name="studiedTill"
    render={({ field }) => (
      <>
        ...
        {errors.studiedTill && (
          <Text style={styles.error}>{errors.studiedTill.message}</Text>
        )}
      </>
    )}
  />
